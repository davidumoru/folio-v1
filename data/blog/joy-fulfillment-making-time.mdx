---
title: 'Making Time for What Brings Me the Most Joy and Fulfillment'
date: '2024-04-25'
# lastmod: '2021-01-18'
tags: ['reflection']
draft: false
summary: 'What brings me the most joy and fulfillment, and how can I make more time for those things?'
# images: ['/static/images']
authors: ['default']
layout: PostLayout
canonicalUrl: https://davidumoru.me/blog/joy-fulfillment-making-time
---
...
Asides coding, I also do graphcs design. It started out as a passion and then realised people actually needed my skill and it kind of became a side gig thing. I work on a range of projects from prints and layout to branding and visual identities. I draw and paint too btw; I've dabbled in watercolors, tried my hand at some basic music production (others might have a different opinion on my "joyful melodies" though lol).

And the thing is: I actually enjoy all of it. Like, genuinely, sparks-of-creativity-flying kind of enjoy it. It got me thinking -  what if the key to my purpose isn't locked away in some dusty corner of computer science, but lies at the intersection of code, canvas, and maybe even a melody or two?
...
This is all a work in progress, of course. But hey, that's the beauty of the journey, right? Figuring it all out, making mistakes, and hopefully, somewhere along the way, finding that sweet spot where code and creativity meet and sparks something truly fulfilling.