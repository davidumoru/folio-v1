...
Here’s how you could introduce the Mermaid diagram in your blog post:
...
This diagram illustrates how the script handles both image and video files, processes them, and then converts them into ASCII art.
...
Feel free to check out [my code](https://github.com/davidumoru/ascii-render) on GitHub and try it out for yourself!it out yourself